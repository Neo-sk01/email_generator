      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="flex-grow p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-screen-xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-black border border-white/10 p-8 rounded-lg">
            ...
            <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-black border border-white/10 p-8 rounded-lg flex flex-col">
              <h2 className="text-xl font-semibold mb-6">Generated Email</h2>
              <div className="bg-black/20 rounded p-4 flex-grow min-h-[300px] whitespace-pre-wrap text-gray-300 flex items-center justify-center">
                {isLoading ? (
